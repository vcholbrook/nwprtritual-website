    ...
    <section className="bg-nwprt-off-white text-nwprt-navy py-20 md:py-28">
      <div className="max-w-7xl mx-auto w-full px-4 md:px-8">
        <motion.div
          ...
          className="mb-12"
        >
          <div className="caption text-nwprt-navy/50 mb-3">The offering</div>
          <h2 className="display text-4xl md:text-6xl text-nwprt-navy mb-6">The Investment</h2>
          <div className="rule bg-nwprt-navy opacity-40 mb-8" />
          <p className="accent-italic text-lg text-nwprt-navy/70">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-nwprt-navy/75 leading-relaxed">
              Short application + 15-minute call with Amy. Selection confirmed within 48 hours. Limited to 24 women.
            </p>
          </div>
        </motion.div>
      </div>
